...
public class CoreMapper {
    public static void createFile(String tableName, List<TableProperties> list, FrameInfo info) throws Exception {
        ...
        try {
            ...
            out = new PrintWriter(info.getPath_core_mapper() + className + "Mapper.java", info.getEncode());
            ...
            out.println("    public Integer deleteByPrimaryKey(" + classNameKey + " " + varNameKey + ");");
            out.println("");

            out.println("    public Integer batchDeleteByPrimaryKey(List<" + classNameKey + "> " + varNameKey + "s);");
            out.println("");

            out.println("    public Integer insertSelective(" + className + " " + varName + ");");
            out.println("");

            out.println("    public Integer batchInsert(List<" + className + "> " + varName + ");");
            out.println("");
            ...
            out.println("    public Integer batchUpdateByPrimaryKey(List<" + className + "> " + varName + ");");
            out.println("");
    ...
    public static void createExtendsFile(String tableName, List<TableProperties> list, FrameInfo info) throws Exception {
        PrintWriter out = null;
        try {
            String className = MyUtils.formatToClassName(tableName);
            //            String classNameExample = className + "Example";
            ...
            out.println("public interface " + className + "Mapper<T> extends BaseDao<T> {");
            //            out.println("{");
            out.println("");
