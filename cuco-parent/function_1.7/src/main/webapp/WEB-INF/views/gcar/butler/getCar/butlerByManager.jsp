        ...
        <div class="searc-sec">
            <div class="searchBox_black">
                <div class="searc-in-sec">
                    ...
                    <input type="search" placeholder="请输入管家姓名或电话" id="search_condition" maxlength="11">
                </div>
...
function searchButlerByMember(){
	...
	$.ajax({
		...
		async:false,
		data:{"name":search_condition,"mobile":search_condition,"isButler":"1"},
		//  返回数据处理
...
function tobutler(memberId){
	...
	window.location.href="${ctx}/wechat/butlerTask/getCar/tobutlerCalendar?memberId="+memberId+"&loginId="+$("#loginId").val();
}
</script>
</html>