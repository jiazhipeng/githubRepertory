$(function () {
  ...
  $(document).on("pageInit", "#page-sex-picker", function(e) {
	    $("#sex-picker").cityPicker({
	    });
	  });
  
  //订单创建会员使用
  $(document).on("pageInit", "#page-city-picker-company", function(e) {
	    $("#city-picker-company").cityPicker_company({
	    });
	  });
  $(document).on("pageInit", "#page-city-picker-person", function(e) {
	    $("#city-picker-person").cityPicker_person({
	    });
	  });
  $.init();
});
