    ...
    var Picker = function (params) {
        ...
        var defaults = {
            ...
            toolbarTemplate: '<header class="bar bar-nav">\
                <button class="button button-link"><span class="cancel-picker" style="float:left;margin-left:1.3rem;">取消</span>   <span class="close-picker pull-right" style="margin-right:1.3rem">确定</span></button> \
                </header>',
        };
        params = params || {};
        for (var def in defaults) {
