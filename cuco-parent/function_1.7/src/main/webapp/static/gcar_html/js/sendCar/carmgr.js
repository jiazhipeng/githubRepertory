...
(function ($, window) {	
    ...
    var CarMgr = {
            ...
            //init  日历
                ...
                onCellClick: function (val) {
                  ...
                  //判断日期 小于当前时间
                    ...
                    window.location.href=basePath+"/wechat/butler/task/sendCar/toTaskSendCarList?loginId="+loginId+"&queryTime="+val+"&butlerId=";
                }
            });
	            $('.page').eq(1).plugin({
	                year: this.props.YEAR,
	                ...
	                onCellClick: function (val) {
	                  ...
	                  //判断日期 小于当前时间
	                    ...
	                    var loginId = $("#loginId").val();
	                    window.location.href=basePath+"/wechat/butler/task/sendCar/toTaskSendCarList?loginId="+loginId+"&queryTime="+val+"&butlerId="+butlerId;
	                }
	            }); 
        ...
        _fetch_car_count:function(date,type){
        	...
        	$.ajax({   
				type: "get",     
				url: '/wechat/butler/task/sendCar/getButlerCalendar',     
				dataType: "json", 
				data: datafile,
