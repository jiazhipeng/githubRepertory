package com.hy.gcar.service.basicOperationType;
 ...
 * 
 * @author auto create
 * @param <BasicOperationType>
 * @since 1.0,2016-09-14 17:40:03
 */
public interface BasicOperationTypeService {
    /**
    *@方法名: insertSelective
    *@方法描述: 根据对象插入单条记录
    *@param tcBasicOperationType
    *@返回值 Integer 返回类型
    *@作者：hycx
    *@创建时间 2016年09月14日 17:40:03
    *@修改时间 2016年09月14日 17:40:03
    *@版本 V1.0
    *@异常
    **/
    ...
    *@方法描述: 分条件查询对象
    *@param tcBasicOperationType
    *@返回值 List<BasicOperationType> 返回类型
    *@作者：hycx
    *@创建时间 2016年09月14日 17:40:03
    *@修改时间 2016年09月14日 17:40:03
    *@版本 V1.0
