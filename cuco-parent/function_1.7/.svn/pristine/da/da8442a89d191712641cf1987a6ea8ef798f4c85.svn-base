...
$.smConfig.rawCitiesData = [{"name":"男","code":1},{"name":"女","code":0}];
}(Zepto);
// jshint ignore: end
...
+ function($) {
    ...
    var defaultsSex = {
        ...
        onChange: function (picker, values, displayValues) {
            ...
            console.log('性别' + rawCitiesData[nowIndex].code);
    ...
    $.fn.cityPickerSex = function(params) {
        return this.each(function() {
            if(!this) return;
            var p = $.extend(defaultsSex, params);
            //计算value
            if (p.value) {
