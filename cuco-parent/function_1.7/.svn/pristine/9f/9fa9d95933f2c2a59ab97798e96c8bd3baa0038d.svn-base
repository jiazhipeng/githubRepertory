    ...
    var setting = {
		...
		$(document).ready(function(){
	      ...
	      $.ajax({
			...
			success: function(data) {
		      ...
		      $("#zhanshidiv${item.id}").html(data.msg);
		...
		function edittitle(id){
			if(pagetype==1){
			   ...
			   $("#quxiao"+id).show();
			   $("#content"+id).show();
			   $("#text"+id).attr('style','resize: none;width:100%;height:150px;font-size:16px;font-family:微软雅黑;line-height:inherit;color:333333;')
		...
		function quxiao(id){
			   ...
			   $("#text"+id).attr('style','width:100%;height:150px;font-size:16px;font-family:微软雅黑;BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-RIGHT: 0px solid; BORDER-TOP: 0px solid;resize: none;line-height:inherit;color:333333;')
								            ...
								            <div style="float:right;padding-top:0px;padding-bottom:0px;BORDER: 0px solid red"  >     
												...
												<#if item.alloweditorflag?exists>
												   <#if item.alloweditorflag=="1">
												   	 ...
												   	 <button id="edittitle${item.id}"   class="btn btn-success btnnew" style="display:none;cursor:pointer!important;" type="button"  onclick="edittitle('${item.id}')" > 编辑</button>
												   </#if>
											     </#if>
										     </div>
									    </td></tr>  
