package com.hy.umeng.push.entity;
 ...
 */
public class MessageUmeng implements Serializable {
    ...
    private Integer applicationType = 0;//应用类型 0 极车公社 1易人易车 2 新能源
    ...
    private String aliasType = "haiyi";//单推类型
    
    
    private Map<String,Object> jsonMap;
    
    
    private int readStatus = 0;//阅读状态
