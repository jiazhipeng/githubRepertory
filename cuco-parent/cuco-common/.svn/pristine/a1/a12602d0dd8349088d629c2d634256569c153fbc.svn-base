package cn.cuco.wechat.pay.util;
...
/**
 * 
* description：wechatPay签名校验    
* author：1mobility    
* time：2017年2月20日 下午4:39:00    
* 修改时间：2017年2月20日 下午4:39:00    
* 修改备注：
 */
public class Signature {
	...
	/**
	 * 签名算法
	 * @deprecated toUpperCase md5加密后转换成全大写
	 * @param o
	 *            要参与签名的数据对象
	 * @return 签名
	...
	public static String getSign(Object o) throws IllegalAccessException {
		...
		result += "key=" + Constant.WECHAT_KEY;
		result = RelyMD5.MD5Encode(result).toUpperCase();
		return result;
	}
