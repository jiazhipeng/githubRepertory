 ...
 * description：
 * author：WangShuai
 * time：2017年02月20 13:49:00
 * 修改时间：2017年02月20 13:49:00
 * 修改备注：
 */
public class ImageQrcodeUtils {

    private static Logger logger = LoggerFactory.getLogger(ImageQrcodeUtils.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String method = "GET";
        String jsonParam = "";
        String result = ImageQrcodeUtils.execute(path, method, jsonParam);
