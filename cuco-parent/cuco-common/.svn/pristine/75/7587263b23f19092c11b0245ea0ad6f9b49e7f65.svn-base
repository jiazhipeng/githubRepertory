...
public class Constant {
	...
	public static final String APPID = Constant.load.getProperty("appid");
	
	public static final String APPIDPAY = Constant.load.getProperty("appidPay");
	
	public static final String MCHID = Constant.load.getProperty("mchid");
	
	public static final String APPSECRET = Constant.load.getProperty("appsecret");
	
	public static final String WECHAT_TOKEN = Constant.load.getProperty("token");
	
	public static final String WECHAT_KEY = Constant.load.getProperty("key");
	
	public static final String domain = Constant.load.getProperty("domain");
	
	public static final String biz = Constant.load.getProperty("biz");
