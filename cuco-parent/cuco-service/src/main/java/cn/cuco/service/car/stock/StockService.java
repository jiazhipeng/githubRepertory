...
public interface StockService {
	...
	/**   
	 * @Title: getUsableCarType   
	 * @Description: 根据用户所选时间得到有库存的车型  
     ...
     * @return: List<Map<String, Object>>      
     */
	public List<Map<String, Object>> getRepertoryByDayForCarType(Long carTypeId, Date startDay, Date endDay);
}
