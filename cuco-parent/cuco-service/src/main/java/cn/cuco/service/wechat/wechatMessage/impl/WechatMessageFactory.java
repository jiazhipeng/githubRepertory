...
public class WechatMessageFactory extends FactoryEngine{
	...
	public Map<String, Object> createSendTaskToCustomer() {
		TaskMessage taskMessage = new TaskMessage();
		taskMessage.setMessage("有新的任务请尽快分配管家");
		taskMessage.setTemplateId(WechatTemplateIDManager.TASK_NOTICE);
		taskMessage.setType("待处理");
		taskMessage.setInfo("送车任务");
		taskMessage.setUrl("www.baidu.com");
		taskMessage.setOpenId(openId);
		return taskMessage.getSendMessage();
	...
	public Map<String, Object> createSendTaskCustomerToOperater() {
		TaskMessage taskMessage = new TaskMessage();
		taskMessage.setMessage("有新的用车任务请尽快确认");
		taskMessage.setTemplateId(WechatTemplateIDManager.TASK_NOTICE);
		taskMessage.setType("待接单");
		taskMessage.setInfo("送车任务");
		taskMessage.setUrl("www.baidu.com");
		taskMessage.setOpenId(openId);
		return taskMessage.getSendMessage();
	...
	public Map<String, Object> createGetTaskCustomerToOperater() {
		TaskMessage taskMessage = new TaskMessage();
		taskMessage.setMessage("有新的任务请尽快确认");
		taskMessage.setTemplateId(WechatTemplateIDManager.TASK_NOTICE);
		taskMessage.setType("待接单");
		taskMessage.setInfo("取车任务");
		taskMessage.setUrl("www.baidu.com");
	...
	public Map<String, Object> createSendOrderTakingtoCarService() {
		TaskMessage taskMessage = new TaskMessage();
		taskMessage.setMessage("有新的用车任务请尽快整备车辆并分配车辆");
		taskMessage.setTemplateId(WechatTemplateIDManager.TASK_NOTICE);
		taskMessage.setType("待取车");
		taskMessage.setInfo("送车任务");
		taskMessage.setUrl("www.baidu.com");
		taskMessage.setOpenId(openId);
		return taskMessage.getSendMessage();
	...
	public Map<String, Object> createOperaterGettoCarService() {
		TaskMessage taskMessage = new TaskMessage();
		taskMessage.setMessage("管家即将前往停车，请做好接车准备");
		taskMessage.setTemplateId(WechatTemplateIDManager.TASK_NOTICE);
		taskMessage.setType("待入库");
		taskMessage.setInfo("取车任务");
		taskMessage.setUrl("www.baidu.com");
		taskMessage.setOpenId(openId);
		return taskMessage.getSendMessage();
