...
public interface ButlerTaskService {
    ...
    * @return List<ButlerTask>
    ...
    /**
    * @Title: getButlerTaskPage 
    * @Description: 分页取管家端任务
    * @author huanghua
    * @param butlerTask
    * @return PageResult<ButlerTask>
    ...
    /**
    * @Title: getButlerTaskPageForCarService 
    * @Description: 分页取车务车务
    * @author huanghua
    * @param butlerTask
    * @return
	...
	* @return PageResult<ButlerTask>
    ...
    /**
    * @Title: updateTaskCustomerToOperater 
    * @Description: 分配管家
    * @author huanghua
    * @param butlerTask
    * @return
    ...
    * @return ButlerTask
    ...
    /**
    * @Title: updateSendButlerTaskByRefuse 
    * @Description: 修改送车任务状态为-拒绝
    * @author huanghua
    * @param butlerTask
    * @return ButlerTask
     */
    ...
    * @return ButlerTask
    ...
    /**
    * @Title: updateGetButlerTaskByInReadiness 
    * @Description: 修改取车任务状态为-整备中
    * @author huanghua
    * @param butlerTask
    * @return ButlerTask
     */
	...
	* @return PageResult<OperateLog>
	...
	/**
	* @Title: updateInReadinessToComplete 
	* @Description: 定时器-整备中变为完成
	* @author huanghua
	* @return void
	 */
	...
	/**
	* @Title: updateArrivedToOutOfContact 
	* @Description: 定时器-已到达变为已失联
	* @author huanghua
	* @return void
	 */
	...
	* @return Integer
	...
	/**
	* @Title: getTaskNumByCompleteDate 
	* @Description: 按时间统计已完成任务数
	* @author huanghua
	* @param butlerTask
	* @return Integer
	 */
