...
public class CarportStatisticsServiceImpl implements CarportStatisticsService {
	...
	private List<Map<String, Object>> getUnlockCarportStatisticsByNum(List<Carport> ports,int type,Date startTime, Date endTime) {
		List<Map<String, Object>> result = new ArrayList<>();
		try {
			long count = 0;
			if (0 == type) {
	...
	private List<Map<String, Object>> getUnlockCarportStatisticsByMoney(List<Carport> ports,int type,Date startTime, Date endTime) {
		List<Map<String, Object>> result = new ArrayList<>();
		try {
			long count = 0;
			if (0 == type) {
