...
public class CartypeController {
     ...
     * @Description: 创建车辆品牌列表
     * @author: wangchuntao 
     * @param carType
     * @return Object
     * @date: 2017年3月11日 下午12:12:54
     */
    @API(value="创建车辆品牌列表")
    @RequestMapping(value = "/cartype/getCarBrandForCreateCar",method = RequestMethod.GET)
    public Object getCarBrandForCreateCar(){
        return carTypeService.getCarBrandForCreateCar();
    }
    
    /**
     * @Title: getCartypeByBrandForCreateCar 
     * @Description: 创建车辆车型列表
     * @author: wangchuntao 
     * @param carType
     * @return Object
     * @date: 2017年3月11日 下午12:13:56
     */
    @API(value="创建车辆车型列表")
    @RequestMapping(value = "/cartype/getCartypeByBrandForCreateCar",method = RequestMethod.POST)
    public Object getCartypeByBrandForCreateCar(@RequestBody CarType carType){
    	return carTypeService.getCartypeByBrandForCreateCar(carType);
    }
