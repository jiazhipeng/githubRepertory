...
public class StatisticsController {
	...
	* @return Object
	...
	public Object addMember(@RequestBody MemberStatisticsVO memberStatisticsVO){
		ParamVerifyUtils.paramNotNull(memberStatisticsVO,"统计参数不可为空");
		ParamVerifyUtils.paramNotNull(memberStatisticsVO.getDate(),"统计周期不可为空");
	...
	public Object membership(@RequestBody MemberStatisticsVO memberStatisticsVO){
		ParamVerifyUtils.paramNotNull(memberStatisticsVO,"统计参数不可为空");
		ParamVerifyUtils.paramNotNull(memberStatisticsVO.getDate(),"统计周期不可为空");
	...
	public Object renewal(@RequestBody MemberStatisticsVO memberStatisticsVO){
		ParamVerifyUtils.paramNotNull(memberStatisticsVO,"统计参数不可为空");
		ParamVerifyUtils.paramNotNull(memberStatisticsVO.getDate(),"统计周期不可为空");
